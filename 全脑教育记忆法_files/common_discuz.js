...
function setMenuPosition(showid, menuid, pos) {
    ...
    switch (direction) {
        case 0:
            menuObj.style.left = (screen.width - menuObj.clientWidth) / 2 - (window.innerWidth - document.documentElement.offsetWidth) / 2 + 'px';
...
function hideMenu(attr, mtype) {
    ...
    if (attr == '') {
        ...
        var hide = function () {
            ...
            var callback = menuObj.getAttribute('data_callback');
            //alert(callback);
            eval(callback);
